...
The MQTT messages were verified using the HiveMQ WebSocket Client by subscribing to the project topics. Published temperature and humidity data were successfully received in JSON format.
